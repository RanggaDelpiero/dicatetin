    ...
    <div className="space-y-4 mt-4">
      ...
      <BottomSheet isOpen={showAddSheet} onClose={() => setShowAddSheet(false)} title="Catat Piutang">
        <div className="p-5 space-y-4">
          ...
          <button
            onClick={handleAdd}
            className="w-full py-4 rounded-2xl bg-accent-secondary text-text-on-accent font-semibold text-base active:scale-[0.98] transition-transform"
          >
            Catat Piutang 📝
          </button>
        </div>
      ...
      <BottomSheet isOpen={showPaySheet !== null} onClose={() => setShowPaySheet(null)} title="Catat Pembayaran">
        <div className="p-5 space-y-4">
          ...
          <button
            ...
            className="w-full py-4 rounded-2xl bg-accent-primary text-text-on-accent font-semibold text-base active:scale-[0.98] transition-transform"
          >
            Catat ✅
          </button>
        </div>
